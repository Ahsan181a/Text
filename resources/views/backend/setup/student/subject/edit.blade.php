    ...
    <section class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3> 
          Edit Subject
            <a class="btn btn-success float-right btn btn-sm" href="{{route('subjects.index')}}"><i class="fa fa-list"></i>Subject List</a>
          </h3>
        </div><!-- /.card-header -->
        <div class="card-body">
         <form method="post" action="{{route('subjects.update',$editData->id)}}" id="myForm">
          @csrf
           @method("PATCH")
            <div class="form-row">
