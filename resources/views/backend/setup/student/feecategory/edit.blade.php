    ...
    <section class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3> 
          Edit FeeCategory
            <a class="btn btn-success float-right btn btn-sm" href="{{route('setup.student.fee.view')}}"><i class="fa fa-list"></i>Feecategory List</a>
          </h3>
        </div><!-- /.card-header -->
        <div class="card-body">
         <form method="post" action="{{route('setup.student.fee.update',$editData->id)}}" id="myForm">
          @csrf
            <div class="form-row">
