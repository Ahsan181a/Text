    ...
    <section class="col-md-12">
      ...
      <div class="card">
       ...
       Edit Year
            ...
            <a class="btn btn-success float-right btn btn-sm" href="{{route('setup.student.year.view')}}"><i class="fa fa-list"></i>year List</a>
          </h3>
        </div><!-- /.card-header -->
        <div class="card-body">
         <form method="post" action="{{route('setup.student.year.update',$editData->id)}}" id="myForm">
          @csrf
            <div class="form-row">
